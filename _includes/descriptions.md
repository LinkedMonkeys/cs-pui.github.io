...
_Excerpt_ Creighton University invites applications for an Assistant Professor in Computer Science. The tenure-track appointment begins in August 2023 in the Department of Computer Science, Design and Journalism.

The candidate must have a terminal degree (doctorate) or be close to finishing their doctoral degree by July 2023.  We seek an individual with the potential to be an excellent teacher-scholar. All areas of scholarship will be considered, but expertise that complements existing research programs in the department (e.g., human-computer interaction, machine learning, social network analytics, computer science education) is desirable.

- Review of completed applications will begin immediately and continue until the position is filled.
- Omaha, Nebraska. USA.

[Full Job Posting](https://creighton.referrals.selectminds.com/jobs/assistant-professor-computer-science-design-and-journalism-3391){: .button-job}
[_back to all deadlines_](#deadlines)
